...
func (bq *BlogQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (bq *BlogQuery) FirstIDX(ctx context.Context) uint64 {
...
func (bq *BlogQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (bq *BlogQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (bq *BlogQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (bq *BlogQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bq *BlogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(blog.Table, blog.Columns, sqlgraph.NewFieldSpec(blog.FieldID, field.TypeUint64))
	_spec.From = bq.sql
...
func (bq *BlogQuery) Modify(modifiers ...func(s *sql.Selector)) *BlogSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (bs *BlogSelect) Modify(modifiers ...func(s *sql.Selector)) *BlogSelect {
